  ...
  return (
    ...
    >
      ...
      <Link to="/" className="group flex items-center gap-2 text-white">
        <div className="relative flex size-7 items-center justify-center rounded-lg border border-white/10 bg-white/5 transition duration-300 group-hover:border-white/30">
