...
const Login = () => {
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        const response = await axios.post(`${API_BASE_URL}/v1/auth/login`, user, {
        ...
        <div className="min-h-screen bg-black flex items-center justify-center relative px-6 py-24 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-sm rounded-2xl border border-neutral-900 bg-neutral-950/40 p-8 shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="font-sans text-xl font-medium tracking-tight text-white">Welcome Back</h1>
                    <p className="font-mono text-[9px] uppercase tracking-widest text-neutral-500 mt-1">
                        CALIBRATE SESSION ACCESS
                    </p>
                </div>
                ...
                <div className="mt-6 flex flex-col gap-2 text-center font-mono text-[9px]">
                    ...
                    <button onClick={() => navigate('/')} className="text-neutral-400 hover:text-white cursor-pointer mt-2">
